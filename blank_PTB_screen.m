...
elseif pace == 2
    ...
    %%
    for i = 1:15
Screen('DrawLines', window, allCoords,lineWidthPix, [255-i*17 255 255-i*17], [xCenter e4 - 220]);
Screen('Flip', window);
WaitSecs(0.005)
    end
    for i = 1:15
Screen('DrawLines', window, allCoords,lineWidthPix, [0+i*17 255 0+i*17], [xCenter e4 - 220]);
Screen('Flip', window);
WaitSecs(0.005);
    end
    %%
